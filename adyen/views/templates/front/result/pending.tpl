...
<p>{l s='Your order on' mod='adyen'} <span class="bold">{$shop_name|escape:'htmlall':'UTF-8'}</span> {l s='is currently pending.' mod='adyen'}
	<br /><br /><span class="bold">{l s='After your payment is received the status of your order will be updated.' mod='adyen'}</span>
