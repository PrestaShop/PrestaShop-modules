...
<p>{l s='Your order on' mod='adyen'} <span class="bold">{$shop_name|escape:'htmlall':'UTF-8'}</span> {l s='is complete.' mod='adyen'}
	<br /><br /><span class="bold">{l s='Your order will be sent very soon.' mod='adyen'}</span>
