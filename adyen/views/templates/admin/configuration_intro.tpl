<div class="adyen-info">
    ...
    <div class="adyen-payement-info right">
        ...
        <a target="_blank" class="adyen-green-button" href="https://www.adyen.com/signup/ecom/"> Request eCommerce test account <i class="icon-caret-right"></i></a>
    </div>

    <div class="adyen-payement-info right">
        <h2>Documentation & Support</h2>
        <p>
            <a target="_blank" href="https://www.adyen.com/dam/documentation/manuals/AdyenPrestaShopExtensionManual.pdf">Click here to download the manual how to setup this plugin</a>
        </p>
        <p>
