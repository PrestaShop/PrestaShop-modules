...
{
	if (TEXTMASTER_SANDBOX_ENVIRONMENT)
		define('TEXTMASTER_CLIENT_ID', 'aebf9da00c81d59d0d907171e230d446a6015dfc6edfe707d43583cad27c4b82');
	elseif (TEXTMASTER_STAGIGN_ENVIRONMENT)
...
{
	if (TEXTMASTER_SANDBOX_ENVIRONMENT)
		define('TEXTMASTER_CLIENT_SECRET', '2767a3825c4770a4e78f2ef8763e2666b7dbf08800cfd7029adb72e728810d9f');
	elseif (TEXTMASTER_STAGIGN_ENVIRONMENT)
