...
<div style="display:block; border: 1px solid #BBB; margin-bottom: 20px;" id="fidbag_form">
	...
	<p style="margin-left: 20px">
		{l s='%1$sFid%2$s\'%3$sBag%4$s is a new consumer %5$sloyalty program for everyone%6$s.' sprintf=['<strong>','</strong><strong style=\'color:rgb(57,180,182)\'>','</strong><strong style=\'color:#D10452\'>','</strong>','<strong style=\'color:#D10452\'>','</strong>'] mod='fidbag'}<br />
		{l s='The way it works is simple : rather than have a loyalty card for each of your favorite stores,' mod='fidbag'}<br />
	 	{l s='you get credit points in a single %1$sFid%2$s\'%3$sBag%4$s account.' sprintf=['<strong>','</strong><strong style=\'color:rgb(57,180,182)\'>','</strong><strong style=\'color:#D10452\'>','</strong>'] mod='fidbag'}<br />
	 	<br />
	 	{l s='These credit points then allow you to have immediate discounts on future purchases,' mod='fidbag'}<br />
	 	{l s='or you can access our catalogs of %1$sgood deals%2$s (cinema, travel, leisure)%3$s on' sprintf=['<strong>','</strong><em>','</em>'] mod='fidbag'} <a href="http://www.fidbag.com">www.fidbag.com</a>.<br />
	 	<br />
		{l s='You have a %1$sFid%2$s\'%3$sBag%4$s account, connect it to your account.' sprintf=['<strong>','</strong><strong style=\'color:rgb(57,180,182)\'>','</strong><strong style=\'color:#D10452\'>','</strong>'] mod='fidbag'}<br />
		{l s='No account? Create your %1$sFid%2$s\'%3$sBag%4$s account now, it\'s fast an free!' sprintf=['<strong>','</strong><strong style=\'color:rgb(57,180,182)\'>','</strong><strong style=\'color:#D10452\'>','</strong>'] mod='fidbag'}
	</p>
