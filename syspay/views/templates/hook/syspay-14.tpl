...
<style>
	.payment_module a:hover { background: none; }
</style>
...
{/if}
<div class="payment_module" style="border: 1px solid black">
    <p style="display: inline-block">
        <a href="javascript:$('form[name=syspay_form_direct]').submit();" style="text-transform: none; border: 0">
            <img style="padding-top: 12px" alt="CB" src="{$module_dir|escape:'htmlall':'UTF-8'}img/button.png">
        </a>
    </p>
    <form name="syspay_form_direct" action="{$syspay_link|escape:'htmlall':'UTF-8'}" method="POST" style="vertical-align: top; display: inline-block; width: 310px; {if $SYSPAY_REBILL == 1 && isset($card)}padding-top: 25px{/if}" >
