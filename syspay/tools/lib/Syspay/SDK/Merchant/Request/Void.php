...
/**
 * Void a payment that is AUTHORIZED
 * @see  https://app.syspay.com/bundles/emiuser/doc/merchant_api.html#void-a-pre-authorization
 */
class Syspay_Merchant_VoidRequest extends Syspay_Merchant_Request
{
    const METHOD = 'POST';
    const PATH   = '/api/v1/merchant/payment/%d/void';
