...
*    @copyright tablefilter.free.fr
*    @author Max Guglielmi.
*    @license MIT License
**/
...
=====================================================*/
{
	...
	if(this.tbl != null && this.tbl.nodeName.tf_LCase() == 'table' && this.GetRowsNb())
    {
        ...
        this.basePath = f.base_path!=undefined ? f.base_path : '../modules/ecopresto/'; //default script base path
		...
		if(this.enableModules){
			...
			this.modulesPath = f.modules_path!=undefined ? f.modules_path : this.basePath+'js/TF_Modules/'; //js modules files path
			this.module = {
		...
		this.stylesheet =   		f.stylesheet!=undefined ? f.stylesheet : this.basePath+'css/filtergrid.css'; //stylesheet file
		...
		this.sortConfig.src =		this.sortConfig['src']!=undefined ? f.sort_config.src : this.basePath+'js/TF_Modules/sortabletable.js';
