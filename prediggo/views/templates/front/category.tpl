		...
		{if $products}
			<div class="content_sortPagiBar">
				...
				<div class="sortPagiBar clearfix">
                    {include file="./search_filters_sort_by_cat.tpl" paninationOff=''}
					{include file="./product-sort.tpl" paginationId='top'}

					{*include file="./nbr-product-page.tpl"*}
				</div>
                <div>{include file="$tpl_dir./product-compare.tpl" paginationId='top'}</div>
			</div>
			...
			<div class="content_sortPagiBar">
                ...
                <div>{include file="$tpl_dir./product-compare.tpl"}</div>
