...
class AdminStatusesControllerCore extends AdminController
{
	...
	public function renderForm()
	{
		$this->fields_form = array(
			...
			'input' => array(
				...
				array(
					...
					'values' => array(
						'query' => array(
							array('id' => 'on', 'name' => $this->l('Отправить письмо поставщику при смене статуса заказа'), 'val' => '1'),
							),
						'id' => 'id',
						'name' => 'name'
					)
		...
		if (Tools::isSubmit('updateorder_state') || Tools::isSubmit('addorder_state'))
			...
			return AdminContollerCore::renderForm();			
	}
	...
	protected function renderOrderStatusForm()
	{
		...
		$sql ="SELECT send_supplier_email FROM "._DB_PREFIX_."order_state WHERE id_order_state=".$obj->id;

		$supplier_email = Db::getInstance()->getValue($sql);		
		...
		$this->fields_value = array(
			...
			'supplier_email_on'=> $supplier_email,
	...
	public function postProcess()
	{
		...
		if (Tools::isSubmit('submitAdd'.$this->table))
		{
			...
			$_POST['send_supplier_email'] = (int)Tools::getValue('supplier_email_on');
			...
			$sql ="UPDATE "._DB_PREFIX_."order_state SET send_supplier_email=".$_POST['send_supplier_email']." WHERE id_order_state=".$_POST['id_order_state'];
