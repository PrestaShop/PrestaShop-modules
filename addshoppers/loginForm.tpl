...
<form action="{$action}" method="post">
        <fieldset class="width2">
                <legend><img src="{$module_dir}../../img/admin/cog.gif" alt="" class="middle" />{l s='Login' mod='addshoppers'}</legend>
                ...
                <center><input type="submit" name="addshoppers_login" value="{l s='Login' mod='addshoppers'}" class="button" /></center>
        </fieldset>
</form>
