...
class Addshoppers extends Module
{
  ...
  public function install()
  {
    ...
    if (count($this->_errors) || !parent::install() || !$this->registerHook('header') || !$this->registerHook('top') || !$this->registerHook('orderConfirmation'))
      return false;
    return true;
  }
  ...
  {
    $categories = array('Select Category', 'Apparel & Clothing', 'Arts & Antiques',
  ...
  protected function _processSettingsForm()
  {
    ...
    {
      $this->_updateConfiguration(Tools::getValue('addshoppers_buttons'), Tools::getValue('addshoppers_opengraph'));
  ...
  protected function _updateConfiguration($buttons = 1, $opengraph = 1)
  {
