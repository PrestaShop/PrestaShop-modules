...
<div class="ctwrapper">
	<header id="header_payu">
		...
		<div class="md-btnhd_payu"> <a href="https://secure.payulatam.com/online_account/create_account.zul" class="md-btn">{l s='Open your PayU Account' mod='payulatam'}</a></div>
	...
	<section class="section_payu">
		<div class="md-wrapper_payu">
			<div class="md-tl_payu">
