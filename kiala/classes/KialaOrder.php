...
class KialaOrder extends ObjectModel
{
	public $id_customer;
	public $id_order;
	public $id_cart;
	...
	protected $table = 'kiala_order';
	protected $identifier = 'id_kiala_order';
	...
	public function getFields()
	{
		...
		$fields['id_kiala_order'] = (int)$this->id;
		...
		$fields['exported'] = (int)$this->exported;
	...
	public static function getLatestByCustomer($id_customer)
	{
		$result = Db::getInstance()->getRow('
			SELECT k.*
			FROM `'._DB_PREFIX_.'kiala_order` k
	...
	public static function cleanEmptyOrders()
	{
		$result = Db::getInstance()->execute('
			DELETE FROM `'._DB_PREFIX_.'kiala_order`
