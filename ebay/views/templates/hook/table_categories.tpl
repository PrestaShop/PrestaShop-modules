		...
		<tr{if $k % 2 !== 0} class="alt_row"{/if} id="category-{$c.id_category}">
			...
			<td>
				<select name="percent[{$c.id_category}][sign]">
					<option value="+:{$currencySign|html_entity_decode:2:'UTF-8'}" {if isset($categoryConfigList[$c.id_category].percent.sign) && $categoryConfigList[$c.id_category].percent.sign == '' && isset($categoryConfigList[$c.id_category].percent.type) && $categoryConfigList[$c.id_category].percent.type == ''} selected{/if}>+ {$currencySign|html_entity_decode:2:'UTF-8'}</option>
					<option value="+:%"{if isset($categoryConfigList[$c.id_category].percent.sign) && $categoryConfigList[$c.id_category].percent.sign == '' && isset($categoryConfigList[$c.id_category].percent.type) && $categoryConfigList[$c.id_category].percent.type == '%'} selected{/if}>+ %</option>
					<option value="-:{$currencySign|html_entity_decode:2:'UTF-8'}" {if isset($categoryConfigList[$c.id_category].percent.sign) && $categoryConfigList[$c.id_category].percent.sign == '-'} selected{/if}>- {$currencySign|html_entity_decode:2:'UTF-8'}</option>
					<option value="-:%" {if isset($categoryConfigList[$c.id_category].percent.sign) && $categoryConfigList[$c.id_category].percent.sign == '-' && isset($categoryConfigList[$c.id_category].percent.type) && $categoryConfigList[$c.id_category].percent.type == '%'} selected{/if}>- %</option>
				</select>
