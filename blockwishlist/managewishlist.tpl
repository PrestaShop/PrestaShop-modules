...
{if $products}
	...
	<div class="wishlistLinkTop">
		...
		<p class="wishlisturl">{l s='Permalink' mod='blockwishlist'}: <input type="text" value="{$base_dir_ssl|rtrim:'/'}{$modules_dir}blockwishlist/view.php?token={$token_wish|escape:'html':'UTF-8'}" style="width:540px;" readonly="readonly" /></p>
		<p class="submit">
