...
<div class="row">
	<div class="col-xs-12 col-md-6">
		...
		<p class="payment_module">
			<a href="#" onclick="$(this).parent().parent().find('form').submit();"><img src="{$module_dir|escape:html:'UTF-8'}/img/desjardins-logo.png" />
				<span>{l s='Pay with Desjardins' mod='desjardins'}</span><span style="clear: both;" />
			</a>
		</p>
	</div>
</div>
