...
$(function() {
    ...
    $(document).ready(function() {
        ...
        $('.addons-checkbox').live("click", function() {
            if ($(this).attr('category') == 'INNE_DANE_LP') {
                if ($(this).is(':checked')) {
                    $("#order_form").RSV({
                        onCompleteHandler: myOnComplete,
                        rules: [
                            "required,custom_lp_nazwa,Uzupełnij nazwe listu przewozowego ",
                            "required,custom_lp_ulica,Uzupełnij ulice listu przewozowego ",
                            "required,custom_lp_dom,Uzupełnij nr dom listu przewozowego ",
                            "required,custom_lp_miasto,Uzupełnij miasto listu przewozowego ",
                            "required,custom_lp_kod,Uzupełnij kod listu przewozowego ",
                            "required,custom_lp_telefon,Uzupełnij telefon listu przewozowego "
                        ]
                    });
                }
            }
