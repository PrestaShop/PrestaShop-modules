...
class MondialRelay extends Module
{
	...
	*/
	...
	public function hookOrderDetailDisplayed($params)
	{
		...
		if ((!$res) OR ($res['dlv_mode'] == 'LD1') OR ($res['dlv_mode'] == 'LDS') OR ($res['dlv_mode'] == 'HOM'))
			return '';
...
if(false) {
	echo 'id_carrier :'.$id_carrier.'<br/>';
	echo 'Country :'.print_r($country->iso_code,true).'<br/>';
	echo 'Zone :'.$id_zone.'<br/>';
	p($carriersList);
	d($carrier);
}
