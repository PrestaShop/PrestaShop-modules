...
class Twenga extends PaymentModule
{
	...
	public function hookDisplayShoppingCart($params)
	{
		...
		return $this->doHook($params, $sEvent);
	}
	...
	public function displayTwengaHowTo()
	{
		...
		$str_return = '
			...
			<fieldset class="moduleTwenga-referencement">
				<legend><img src="../modules/'.$this->name.'/logo-small.png" width="16" height="16" class="middle" /> '.$this->l('A - List your website on Twenga').'</legend>

				<div class="no-inscr">
					<img src="../modules/'.$this->name.'/puce.png" width="16" height="16" alt="Twenga" /> <a href="#" class="display">'.$this->l('You have never had a Twenga Ready to Sell account').'</a>
					<ol>
				...
				<div class="inscr">
					<img src="../modules/'.$this->name.'/puce.png" width="16" height="16" alt="Twenga" /> <a href="#" class="display">'.$this->l('You are already registered to the Twenga Ready to Sell programme').'</a>
					<ol>
	...
	public function displayTwengaIntro()
	{
		...
		$str_return = '
			...
			<link type="text/css" rel="stylesheet" href="../modules/'.$this->name.'/module-twenga.css" />

			<div class="module-twenga">
				<div class="moduleTwenga-intro" style="background-image:url(../modules/'.$this->name.'/cible-twenga.png);")>
					<p><img src="../modules/'.$this->name.'/logo-twenga.png" width="200" height="43" alt="Twenga" /></p>
	...
	public function displayFeedUrl()
	{
		...
		<br />
		<fieldset class="moduleTwenga-referencement">
			<legend><img src="../modules/'.$this->name.'/logo-small.png" width="16" height="16" class="middle" /> '.$this->l('Your Twenga Product Export').'</legend>
	...
	private function displayTwengaLogin()
	{
		...
		$output = '
			<form name="form_set_hashkey" action="" method="post">
				...
				<legend>
					<img src="../modules/'.$this->name.'/logo-small.png" width="16" height="16" class="middle" /> ';
	...
	private function displayTwengaTestimony()
	{
		...
		$output = '<div class="banner-twenga"><img src="../modules/'.$this->name.'/'.$link_banner.'.png" width="1000" height="150" alt="Awards" /></div>';
		return $output;
	}
	...
	private function displayEnableTracker()
	{
		...
		<form name="form_twenga_activate" method="post" action="">
			<fieldset class="moduleTwenga-activation">
				<legend><img src="../modules/'.$this->name.'/logo-small.png" width="16" height="16" class="middle" />%s</legend>
	...
	private function displayDisableTracker()
	{
		...
		<div class="disable-twenga"><form name="form_twenga_activate" method="post" action="">
			<fieldset>
				...
				<p>%s</p>
				<p><input type="submit" name="%s" class="button" value="%s" /></p>
				<p>'.$this->l('Your statistics tracking is available from').' <a href="">'.$this->l('your Twenga Ready to Sell interface').'</a>.</p>
