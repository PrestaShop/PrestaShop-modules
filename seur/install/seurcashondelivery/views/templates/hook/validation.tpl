...
<form action="{$this_path_ssl|escape:'htmlall':'UTF-8'}validation.php" method="post">
        ...
        <p>
                <img src="{$this_path|escape:'htmlall':'UTF-8'}img/logoSeur.png" alt="{l s='Cash on delivery by SEUR' mod='seurcashondelivery'}" style="float:left; margin: 0px 10px 5px 0px;" />
                ...
                <span id="amount_{$currencies.0.id_currency|escape:'htmlall':'UTF-8'}" class="price">{convertPrice price=$total|floatval}</span>
        </p>
        <p>
                <br /><br />
                <br /><br />
