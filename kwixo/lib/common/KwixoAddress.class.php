 ...
 */
class KwixoAddress extends KwixoXMLElement {
  ...
  /**
   * creates an object KwixoXMLElement representing the element <appartement>, child of <adresse>, adds it to the current object then returns it
   * 
