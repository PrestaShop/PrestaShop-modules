...
*  @version  Release: $Revision: 16428 $
		...
		<div data-role="page">
			...
			<div data-role="content">
				<div class="ui-overlay-shadow ui-body-e ui-corner-all" style="padding: 12px; margin: 15px 0;">
						<p>{l s='In order to perform site maintenance, our online shop has shut down temporarily. We apologize for the inconvenience and ask that you please try again later.'}</p>
				</div>
			</div>
