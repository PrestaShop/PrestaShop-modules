...
<form action="{$this_path_ssl}validation.php" method="post">
	...
	<p class="cart_navigation submit" style="text-align: center; margin-top: 10px;">
		<a data-role="button" data-icon="back" data-posicon="left" data-mini="true" data-inline="true" href="{$link->getPageLink('order.php', true)}?step=3">{l s='Previous' mod='bankwire'}</a>
		<input type="submit" name="submit" data-icon="check" data-mini="true" data-iconpos="right" data-theme="{$ps_mobile_styles.PS_MOBILE_THEME_BUTTONS}" data-inline="true" value="{l s='I confirm my order' mod='bankwire'}" />
	</p>
</form>
